...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>nick-jonas.github.com/windows/scss/config.rb at master · nick-jonas/nick-jonas.github.com · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/805682?s=400" property="og:image" /><meta content="nick-jonas/nick-jonas.github.com" property="og:title" /><meta content="https://github.com/nick-jonas/nick-jonas.github.com" property="og:url" /><meta content="nick-jonas.github.com - Demo sites" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4B9B42AB:3D65:63C4528:53893F8F" name="octolytics-dimension-request_id" />
...
<meta content="ureIpRsKewOx6VZZWfxHGOBNzyDt3Vtgnd+MzwVZSZtboK2nySZlq5b1Db2qxNr53y1JSDRoNe8kNQZAxrwrIw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fnick-jonas%2Fnick-jonas.github.com%2Fblob%2Fmaster%2Fwindows%2Fscss%2Fconfig.rb">Sign in</a>
    </div>
...
<a href="/nick-jonas/nick-jonas.github.com/blob/799864e1d72a5afd536d3a907df6ee3f6aa7e6b0/windows/scss/config.rb" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:bdfc299e2e4402ebd250013c3beecd65 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/nick-jonas/nick-jonas.github.com/blob/master/windows/scss/config.rb"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped tooltipped-w js-conduit-openfile-check"
               ...
               data-url="github-mac://openRepo/https://github.com/nick-jonas/nick-jonas.github.com?branch=master&amp;filepath=windows%2Fscss%2Fconfig.rb"
          ...
          <a href="/nick-jonas/nick-jonas.github.com/raw/master/windows/scss/config.rb" class="button minibutton " id="raw-url">Raw</a>
            <a href="/nick-jonas/nick-jonas.github.com/blame/master/windows/scss/config.rb" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/nick-jonas/nick-jonas.github.com/commits/master/windows/scss/config.rb" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L21" rel="#L21">21</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c1"># Set this to the root of your project when deployed:</span></div><div class='line' id='LC2'><span class="n">http_path</span> <span class="o">=</span> <span class="s2">&quot;../&quot;</span></div><div class='line' id='LC3'><span class="n">css_dir</span> <span class="o">=</span> <span class="s2">&quot;../css&quot;</span></div><div class='line' id='LC4'><span class="n">sass_dir</span> <span class="o">=</span> <span class="s2">&quot;./&quot;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="c1"># You can select your preferred output style here (can be overridden via the command line):</span></div><div class='line' id='LC7'><span class="c1"># output_style = :expanded or :nested or :compact or :compressed</span></div><div class='line' id='LC8'><span class="n">output_style</span> <span class="o">=</span> <span class="ss">:expanded</span><span class="p">;</span></div><div class='line' id='LC9'><br/></div><div class='line' id='LC10'><span class="c1"># To enable relative paths to assets via compass helper functions. Uncomment:</span></div><div class='line' id='LC11'><span class="n">relative_assets</span> <span class="o">=</span> <span class="kp">true</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'><span class="c1"># To disable debugging comments that display the original location of your selectors. Uncomment:</span></div><div class='line' id='LC14'><span class="n">line_comments</span> <span class="o">=</span> <span class="kp">true</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'><span class="c1"># If you prefer the indented syntax, you might want to regenerate this</span></div><div class='line' id='LC18'><span class="c1"># project again passing --syntax sass, or you can uncomment this:</span></div><div class='line' id='LC19'><span class="c1"># preferred_syntax = :sass</span></div><div class='line' id='LC20'><span class="c1"># and then run:</span></div><div class='line' id='LC21'><span class="c1"># sass-convert -R --from scss --to sass sass scss &amp;&amp; rm -rf sass &amp;&amp; mv scss sass</span></div></pre></div></td>
         </tr>
       </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.03590s from github-fe132-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
