...
<div class="news mod_flexicontent_wrapper mod_flexicontent_wrap<?php echo $moduleclass_sfx; ?>" id="mod_flexicontent_news<?php echo $container_id; ?>">
	...
	?>
	<div id="<?php echo 'order_'.$order_name.$container_id; ?>" class="listings-module">
	...
	<?php if (isset($list[$ord]['standard'])) : ?>
		...
		<div class="listing-group unique-lising-<?php echo $uniq_ord_id; ?>" id="unique_listing_<?php echo $uniq_ord_id; ?>">
			...
			<!-- BOF current item -->	
			<div class="listing-item unique-listing-item-<?php echo $uniq_ord_id; ?> <?php echo $mod_do_hlight; ?><?php echo ' '.$oe_class .($item->is_active_item ? ' fcitem_active' : '') .($cols_class_std ? ' '.$cols_class_std : ''); ?>"
				onmouseover=""
				onmouseout=""
			>
			<div class="listing-item-inner">
				...
				<div class="fc_block" >
					<div class="listing-item-title fc_inline fcitem_title">
						<?php if ($link_title) : ?>
							<a href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
						<?php else : ?>	
							<?php echo $item->title; ?>
	...
	<div class="modclear clearfix"></div>
